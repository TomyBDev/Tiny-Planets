...
void AHelloARManager::StopTrackingPlanes()
{
	UARBlueprintLibrary::ToggleARCapture(false, EARCaptureType::SpatialMapping);
	TArray<UARPlaneGeometry*> geometries = UARBlueprintLibrary::GetAllGeometriesByClass<UARPlaneGeometry>();
	for (UARPlaneGeometry* It : geometries)
	{
